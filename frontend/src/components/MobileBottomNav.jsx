...
export function MobileBottomNav() {
  ...
  return (
    <div 
      className="fixed bottom-2 left-2 right-2 z-[100] flex items-center justify-around bg-base-100 border border-base-200 shadow-[0_-4px_20px_rgba(0,0,0,0.1)] lg:hidden pt-2 rounded-2xl"
